	...
	var treeData = [
			{
				...
				children : [
						...
						},
						{
							text : "保司效益险种贡献",
							attributes : {
								url : '<iframe width="100%" height="100%" frameborder="0"  src="/bshzfx/tobssyxzgxanalyse" style="width:100%;height:100%;margin:0px 0px;"></iframe>'
							}
						},
						{
							text : "保司推送修满足率",
			...
			},
			{
				...
				children : [
						...
						},
						{
							text : "保险回厂频次贡献",
							attributes : {
								url : '<iframe width="100%" height="100%" frameborder="0"  src="/bxgxfx/tobxhcpcgxanalyse" style="width:100%;height:100%;margin:0px 0px;"></iframe>'
							}
						},
						{
							text : "续保业务分析",
							attributes : {
								url : '<iframe width="100%" height="100%" frameborder="0"  src="/bxgxfx/toxbywfxanalyse" style="width:100%;height:100%;margin:0px 0px;"></iframe>'
							}
						},
						{
							text : "售后赋能子险贡献",
